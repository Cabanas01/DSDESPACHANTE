      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10 h-14 px-10 text-lg font-bold" asChild>
              <Link href={LINKS.WHATSAPP} target="_blank">
                <MessageCircle className="w-5 h-5 mr-2 text-[#25D366]" /> Falar no WhatsApp
              </Link>
            </Button>
          </div>
