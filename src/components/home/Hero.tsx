  ...
  return (
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image 
          src="https://images.unsplash.com/photo-1542362567-b05503f3af15?auto=format&fit=crop&q=80&w=1920" 
          alt="Premium Highway Background" 
          fill 
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            ...
            <div className="flex items-center gap-3 py-2">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="w-10 h-10 rounded-full border-2 border-white bg-muted overflow-hidden">
                    <img src={`https://picsum.photos/seed/${i + 10}/40/40`} alt="User avatar" />
                  </div>
                ))}
              </div>
              <div className="flex flex-col">
                ...
                <span className="text-xs font-medium text-white/70">+12.000 Alunos Formados</span>
              </div>
            </div>
          </div>
        </div>
